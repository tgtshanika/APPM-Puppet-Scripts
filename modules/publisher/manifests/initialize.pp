...
define publisher::initialize ($repo, $version, $service, $local_dir, $target, $mode, $owner,) {
  ...
  file {
    "/${local_dir}/wso2${service}-${version}.zip":
      ...
      source => ["puppet:///modules/distributions/wso2/${service}/${version}/wso2${service}-${version}.zip", "puppet:///packs/wso2${service}-${version}.zip"],
